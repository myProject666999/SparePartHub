        ...
        <div class="toolbar">
          ...
          <div class="toolbar-right">
            <button nz-button nzType="primary" (click)="router.navigate(['/spare-parts/new'])">
              <i nz-icon nzType="plus-outline"></i> 新建备件
            </button>
          </div>
        </div>
              ...
              <td>
                <ng-container *ngIf="item.currentStock !== undefined">
                  <span *ngIf="item.currentStock <= (item.safetyStock || 0)" style="color: #f5222d; font-weight: bold;">
                    {{ item.currentStock }}
                    <i nz-icon nzType="warning-outline" style="color: #faad14;"></i>
                  </span>
...
@Component({
  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        <button nz-button (click)="router.navigate(['/spare-parts'])"><i nz-icon nzType="arrow-left-outline"></i> 返回</button>
